define([
    ...
    return ['activityChooser', 'keyboardManager', 'template', function(activityChooser, keyboardManager, template) {
        return {
            scope: {},
            templateUrl: template('scripts/superdesk/activity/views/activity-chooser.html'),
